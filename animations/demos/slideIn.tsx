...
const SlideInDemo: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[300px] bg-gradient-to-br from-green-500/10 to-blue-500/10 rounded-lg p-8">
      ...
      <div className="flex items-center justify-center h-full">
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="w-32 h-32 bg-gradient-to-br from-green-500 to-blue-500 rounded-lg shadow-lg"
        />
      </div>
    </div>
  );
