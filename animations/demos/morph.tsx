...
const MorphDemo: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[300px] bg-gradient-to-br from-fuchsia-500/10 to-purple-500/10 rounded-lg p-8">
      ...
      <div className="flex items-center justify-center h-full">
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="w-24 h-24 bg-gradient-to-br from-fuchsia-500 to-purple-500 rounded-lg shadow-lg"
        />
      </div>
    </div>
  );
