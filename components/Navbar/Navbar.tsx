...
const Navbar: React.FC = () => {
  return (
    <nav className="w-full h-24 px-20 py-10 flex justify-between items-center max-sm:px-6">
        ...
        <div className="menu flex flow-row gap-10 justify-center items-center">
            <a href={'https://github.com/Gitnaseem745'} target="_blank" className="rounded-md text-[16px] max-sm:text-sm font-semibold max-sm:hidden text-white/50 transition-all ease-in-out hover:text-white">Dev</a>
            <a href={'https://github.com/Gitnaseem745/solaris-ui'} target="_blank" className="text-sm font-semibold font-sans">
