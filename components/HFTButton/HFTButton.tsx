      ...
      <button
        ...
        className={`
                   ...
                   bg-transparent hover:text-black transition-all duration-[0.5s] hover:border-black
                    before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-0  before:bg-yellow-300 before:transition-all before:duration-[0.5s] hover:before:h-[180%] before:-z-10
                    `}
      >
        {label}
      </button>
