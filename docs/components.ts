...
import { BannerAlertShowcase, BouncingAlertShowcase, ColorChangingAlertShowcase, ConfirmationAlertShowcase, CountdownAlertShowcase, ErrorAlertShowcase, ExpandingAlertShowcase, FadingAlertShowcase, FlipAlertShowcase, FloatingAlertShowcase, InfoAlertShowcase, ProgressAlertShowcase, PulsatingAlertShowcase, RotatingAlertShowcase, ShakingAlertShowcase, SlideInAlertShowcase, StickyAlertShowcase, SuccessAlertShowcase, SwipeAlertShowcase, ToastAlertShowcase, TypingAlertShowcase, WarningAlertShowcase } from "@/components/ui/alert-showcases";
    ...
    alerts: [
      ...
      export default function MyComponent() {
        ...
        },
        {
          id: 'outline-switch',
          name: 'Outline Switch',
          description: 'A switch component with an outline style.',
          dependencies: 'None',
          installation: 'No additional installation required',
          usage: `
      import { OutlineSwitch } from '@/components/switches/outline-switch';
      ...
      export default function MyComponent() {
        ...
        return (
          ...
          examples: [
            {
              name: 'Default Outline Switch',
              code: '<OutlineSwitch id="outline-switch" name="outline-switch" checked={false} onChange={() => {}} label="Outline Switch" />',
            },
          ],
          Component: OutlineSwitchShowcase,
        },
        {
          id: 'image-switch',
          name: 'Image Switch',
          description: 'A switch component that uses images.',
          dependencies: 'None',
          installation: 'No additional installation required',
          usage: `
      import { ImageSwitch } from '@/components/switches/image-switch';
      ...
      export default function MyComponent() {
        ...
        return (
          ...
          examples: [
            {
              name: 'Default Image Switch',
              code: '<ImageSwitch id="image-switch" name="image-switch" checked={false} onChange={() => {}} label="Image Switch" />',
            },
          ],
          Component: ImageSwitchShowcase,
        },
        {
          id: 'toggle-switch',
          name: 'Toggle Switch',
      ...
      export default function MyComponent() {
        ...
        },
        {
          ...
          description: 'A switch component with a color picker.',
          dependencies: 'None',
          installation: 'No additional installation required',
          usage: `
      import { ColorPickerSwitch } from '@/components/switches/color-picker-switch';
      ...
      export default function MyComponent() {
        ...
        return (
          ...
          examples: [
            {
              name: 'Default Color Picker Switch',
              code: '<ColorPickerSwitch id="color-picker-switch" name="color-picker-switch" checked={false} onChange={() => {}} label="Color Picker Switch" />',
            },
          ],
          Component: ColorPickerSwitchShowcase,
        },
        {
          id: 'size-picker-switch',
          name: 'Size Picker Switch',
          description: 'A switch component with a size picker.',
          dependencies: 'None',
          installation: 'No additional installation required',
          usage: `
      import { SizePickerSwitch } from '@/components/switches/size-picker-switch';
      ...
      export default function MyComponent() {
        ...
        return (
          ...
          examples: [
            {
              name: 'Default Size Picker Switch',
              code: '<SizePickerSwitch id="size-picker-switch" name="size-picker-switch" checked={false} onChange={() => {}} label="Size Picker Switch" />',
            },
          ],
          Component: SizePickerSwitchShowcase,
        },
        {
          id: 'gradient-switch',
      ...
      export default function MyComponent() {
        ...
        },
        {
          ...
          description: 'A switch component with a textured background.',
          dependencies: 'None',
          installation: 'No additional installation required',
          usage: `
      import { TexturedSwitch } from '@/components/switches/textured-switch';
      ...
      export default function MyComponent() {
        ...
        return (
          ...
          examples: [
            {
              name: 'Default Textured Switch',
              code: '<TexturedSwitch id="textured-switch" name="textured-switch" checked={false} onChange={() => {}} label="Textured Switch" />',
            },
          ],
          Component: TexturedSwitchShowcase,
        },
        {
